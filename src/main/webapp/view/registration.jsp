...
<section class="contact" id="contact">
    <div class="container">
        ...
        <form <%--method="post" action="/newUser"--%> name="user" class="contact_form" onsubmit="event.preventDefault();submitForm(this);">
            <input type="text" required placeholder="Name" name="name">
            <input type="text" required placeholder="Surname" name="surname">
            <input type="tel" required placeholder="Phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" name="phone">
